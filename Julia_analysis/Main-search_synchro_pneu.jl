...
filenameMTiXsens=load("imports/import_filename_MTiXsens_pneu.jld")["filenameMTiXsens"]
sensorXsensNames=load("imports/import_filename_MTiXsens_pneu.jld")["sensorXsensNames"]
filenameMTiXsensID=load("imports/import_filename_MTiXsens_pneu.jld")["filenameMTiXsensID"]

## Xsensor
#filenameXsensor : namefile of each experiment
# include("imports/Import_filename_Xsensor.jl")
filenameXsensor=load("imports/Import_filename_Xsensor_pneu.jld")["filenameXsensor"]


## Instrumented_backseat
#filenameIBS : namefile of each experiment
# include("imports/Import_filename_IBS.jl")
filenameIBS=load("imports/Import_filename_IBS_pneu.jld")["filenameIBS"]
...
index_test_MTiXsens_1cm=searchAllSynchroMTiXsens(AccFree_MTiXsens,filenameMTiXsens[1:30,:],:dossier,20,10,2,2,25,100)
index_test_MTiXsens_2cm=searchAllSynchroMTiXsens(AccFree_MTiXsens,filenameMTiXsens[31:60,:],:siege,20,4,2,2,15,100)
index_test_MTiXsens_3cm=searchAllSynchroMTiXsens(AccFree_MTiXsens,filenameMTiXsens[61:90,:],:dossier,20,10^3)
index_test_MTiXsens_4cm=searchAllSynchroMTiXsens(AccFree_MTiXsens,filenameMTiXsens[91:end,:],:dossier,20,10^3)
...
ind=[51, 55, 59, 60]
index_test_MTiXsens_03=searchAllSynchroMTiXsens(AccFree_MTiXsens,filenameMTiXsens[ind,:],:siege,20,20,2,2,15,100)
index_test_MTiXsens[ind].=index_test_MTiXsens_03
...
save("imports/import_synchro_pneu.jld", "sync", sync)
save("imports/Import_synchro_perturb_pneu.jld", "sync_", sync_,
