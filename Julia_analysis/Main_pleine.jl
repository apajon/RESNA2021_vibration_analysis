...
sync=load("imports/import_synchro_pleine.jld")["sync"]
...
sync_=load("imports/Import_synchro_perturb_pleine.jld")["sync_"]
step_max_perturb=load("imports/Import_synchro_perturb_pleine.jld")["step_max_perturb"]
