...
sync=load("imports/import_synchro_gel.jld")["sync"]
...
sync_=load("imports/Import_synchro_perturb_gel.jld")["sync_"]
step_max_perturb=load("imports/Import_synchro_perturb_gel.jld")["step_max_perturb"]
